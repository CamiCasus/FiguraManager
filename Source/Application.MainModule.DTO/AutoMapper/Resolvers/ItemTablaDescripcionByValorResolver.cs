...
{
    public class ItemTablaDescripcionByValorResolver : ValueResolver<object, string>
    {
        ...
        public ItemTablaDescripcionByValorResolver(string propertyName, TipoTabla tipoTabla)
        {
        ...
        protected override string ResolveCore(object source)
        {
            ...
            return itemTablaActual != null ? itemTablaActual.Descripcion : string.Empty;
        }
